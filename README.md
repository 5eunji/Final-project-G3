...
## Huggingface  - Gradio Audio Recorder 파이썬 코드를 못찾았어요...! 교수님이 올려주신 수업 콜랩 자료 중에 해당 코드 있으면 알려주시면 감사하겠습니다!
   
**| Gradio Wordcloud App | Gradio TTS Listening App(1) | Gradio TTS Listening App(2) | Gradio Audio Recorder
|:--:|:--:|:--:|:--:|:--:|
